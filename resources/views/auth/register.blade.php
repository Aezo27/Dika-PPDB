  ...
  <div class="col-12 col-md-4 peer pX-40 pY-80 h-100 bgc-white scrollable pos-r" style="min-width:320px">
    ...
    <form method="POST" action="{{ route('register') }}">
      ...
      <div class="form-group"><label class="text-normal text-dark">Username</label>
        <input type="text"class="form-control" name="name" placeholder="John Doe" onkeypress="return event.charCode != 32" value="{{ old('name') }}" required autofocus>
        @error('name')
      ...
      <div class="form-group"><label class="text-normal text-dark">Alamat Email</label>
        <input type="email" style="text-transform: none" class="form-control" name="email" required value="{{ old('email') }}" placeholder="nama@email.com">
        @error('email')
          <span style="display: block" class="invalid-feedback" role="alert">
